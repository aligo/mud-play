...
int main() {
  ...
  mud_object_t * object_nil = initMudObjectWithNSObject(stack, [NSNull null]);
  NSLog(@"object_nil should be mud_nil: 1 == %d", object_nil->type == MUD_OBJ_TYPE_NIL);
  

  mud_object_t * object_boolean = initMudObjectWithNSObject(stack, @(YES));
  ...
  mud_object_t * object_int = initMudObjectWithNSObject(stack, [NSNumber numberWithInt: 100]);
  ...
  mud_object_t * object_float = initMudObjectWithNSObject(stack, [NSNumber numberWithDouble: 2015.0112]);
  ...
  mud_object_t * object_string = initMudObjectWithNSObject(stack, @"hello world! 你好世界！");
  ...
  mud_object_t * object_expr1 = _initMudExprWithNSArray(stack, @[@2015, @"test", @"test2"]);
  ...
  mud_object_t * object_expr2 = _initMudExprWithNSArray(stack, @[@2014]);
  ...
  mud_object_t * object_exprs1 = _initMudExprsWithNSArray(stack, ns_exprs1);
