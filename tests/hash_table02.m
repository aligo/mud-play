...
int main() {
  ...
  NSLog(@"(htfilter, (ht, 'c', 3, 'a', 1, 'b', 2), (lambda, (%%, (sarg, 1), 2))) should be: { a = 1, c = 3 } == %@", nsMudTestEvaluate(
    @[@623, @[@600, @"c", @3, @"a", @1, @"b", @2], @[@130, @[@204, @[@122, @1], @2]]]
  ));

  NSLog(@"(htreject, (ht, 'c', 3, 'a', 1, 'b', 2), (lambda, (%%, (sarg, 1), 2))) should be: { b = 2 } == %@", nsMudTestEvaluate(
    @[@624, @[@600, @"c", @3, @"a", @1, @"b", @2], @[@130, @[@204, @[@122, @1], @2]]]
  ));
