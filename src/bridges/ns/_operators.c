...
// auto-generated: operators switch - begin
    ...
    case MUD_OP_HASH_TABLE_HT:
      ...
      break;
    case MUD_OP_HASH_TABLE_COUNT:
      ret = _mud_op_hash_table_count_evaluate(evaluator);
      break;
    case MUD_OP_HASH_TABLE_GET:
      ret = _mud_op_hash_table_get_evaluate(evaluator);
      break;
    ...
    case MUD_OP_HASH_TABLE_PAIRS:
      ...
      break;
    case MUD_OP_HASH_TABLE_MERGE:
      ret = _mud_op_hash_table_merge_evaluate(evaluator);
      break;
    ...
    case MUD_OP_HASH_TABLE_SORT_BY:
      ...
      break;
    case MUD_OP_HASH_TABLE_SORT:
      ret = _mud_op_hash_table_sort_evaluate(evaluator);
      break;
    case MUD_OP_NS_INFO:
